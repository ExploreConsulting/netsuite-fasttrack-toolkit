...
;(function (lazy) {
    ...
    var log = LogManager.getLogger('lazy')
    /**
    ...
    lazy.createSearch = function (recordType, filters, columns) {
        return Lazy().createSearch(recordType, filters, columns)
    }

    lazy.loadSearch = function (recordType, id) {
        return Lazy().loadSearch(recordType, id)
    }

    lazy.fromSearch = function (searchObj) {
        return Lazy().fromSearch(searchObj)
    }

    lazy.getTotalRecordCount = function (recordtype, filters) {
